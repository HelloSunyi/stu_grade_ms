...
<html>
  <head>
	...
	<link rel="stylesheet" href="<%=request.getContextPath()%>/resource/css/student/studentIndex.css" type="text/css">
	...
	<script src="<%=request.getContextPath()%>/resource/script/student/studentIndex.js"></script>
  ...
  <body>
  	...
  	<div id="header">
  		<div class="container">
  			...
  			<span class="grade-info"><a href="student/index">课程成绩</a></span>
  			<span class="select-info tab-on"><a href="student/selectCourse">选课</a></span>
  		</div>
  	</div>
  	<!-- header 标签结束 -->
  		...
  		<div class="grade-info-tab tab-info-on container">
  			<div class="table-responsive">
			    <table class="table table-hover">
				   ...
				   <tbody>
				   	 <c:forEach items="${courseGradeList}" var="clist">
  						<tr>
  			...
  			<a class="btn btn-success btn-lg" id="delete-btn">删除课程</a>
  		</div>
