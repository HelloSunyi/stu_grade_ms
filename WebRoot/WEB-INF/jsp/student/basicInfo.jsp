...
<html>
  <head>
	...
	<link rel="stylesheet" href="<%=request.getContextPath()%>/resource/css/student/basicInfo.css" type="text/css">
	...
	<script src="<%=request.getContextPath()%>/resource/script/student/basicInfo.js"></script>
  	...
  	<div id="mainbody">
  			...
  			<div class="mainbody-left">
  				...
  				<ul class="list-group list-content">
  					...
  					<li class="list-group-item capsule"><a href="student/index">课程成绩</a></li>
  					<li class="list-group-item capsule"><a href="student/selectCourse">选课</a></li>
  				</ul>	
  			</div>
  				...
  				<div class="mainbody-right-middle">
  					<form class="form-inline" role="form" >	
						...
						<div class="form-group">
						    ...
						    name="classNo" value="${student.classNo }" />
						    <i class="glyphicon glyphicon-pencil"></i>
						</div>
						<div class="form-group">
							<label>专业：</label>			   
					...
					<a href="student/basicInfo" class="btn btn-success btn-lg reset-btn">重置</a>
