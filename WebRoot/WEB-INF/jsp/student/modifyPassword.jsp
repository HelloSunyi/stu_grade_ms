...
<html>
  <head>
	...
	<link rel="stylesheet" href="<%=request.getContextPath()%>/resource/css/student/modifyPassword.css" type="text/css">
	...
	<script src="<%=request.getContextPath()%>/resource/script/student/modifyPassword.js"></script>
